  ...
  <div class="w3-content" style="max-width:600px">
    ...
    <v-date-picker v-model="picker"></v-date-picker>
      ...
      <div class="w3-section">
        <label>Name</label>
        <input class="w3-input w3-border" type="text" placeholder="Name" id="naam" required name="entry.361348176">
        <label>Voornaam</label>
        <input class="w3-input w3-border" type="text" placeholder="Name" id="voornaam" required name="entry.1031056222">
        <label>Email</label>
        <input class="w3-input w3-border" type="email" placeholder="Name" id="email" required name="entry.929403391">
        <label>Datum</label>
        <input class="w3-input w3-border" type="date" placeholder="Name" id="date" required name="entry.931986751">
        <label>Woonplaats</label>
        <input class="w3-input w3-border" type="text" placeholder="Name" id="woonplaats" required  >
      </div>
      <div class="form-group" name="entry.1284250062">
        <label for="rsvpStatus">Welke BV</label>
        <div>
          <label><input type="radio" name="entry.1284250062" value="Hilde De Baerdemaeker">Hilde De Baerdemaeker</label>
        </div>
        <div>
          <label><input type="radio" name="entry.1284250062" value="Maaike Cafmeyer">Maaike Cafmeyer</label>
        </div>
        <div>
          <label><input type="radio" name="entry.1284250062" value="Ella Leyers">Ella Leyers</label>
        </div>
        <div>
          <label><input type="radio" name="entry.1284250062" value="Leen Dendievel">Leen Dendievel</label>
        </div>
        <div>
          <label><input type="radio" name="entry.1284250062" value="Justine De Jonckheere">Justine De Jonckheere</label>
        </div>
      </div>

      <div class="form-group" name="entry.196644817">
        <label for="rsvpStatus">Nieuwsbrief</label>
        <div>
          <label><input type="radio" name="entry.196644817" value="Ja">Ja</label>
        </div>
        <div>
          <label><input type="radio" name="entry.196644817" value="Nee">Nee</label>
        </div>
      </div>
